...
|--------|---------------|-----------|-------|
| **Max Context (no mmproj)** | **256K** (22.4 GB VRAM) | **71K** (22.6 GB VRAM) | **3.6x** |
...
- **27B Dense**: All 28 layers need KV cache → maxes out at 71K on L4 24GB with KV q4_0 quantization
